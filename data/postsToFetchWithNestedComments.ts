export const postsToFetch = [
   ...
   },
   {
      ...
      comments: [
         {
            id: "fsadfdsa25213",
            text: "That's a lot of money to repaint all those trucks, that was a commitment",
         },
         {
            id: "vytr547v",
            text: `Sorry, let me rephrase: historically they have been white. Most still are. This one was just outside of my shop this morning. I am hoping that all future trucks are this color.`,
         },
         {
            id: "6g542547bg4yb",
            text: `Even if this truck was scheduled to be repainted it is harder to repaint with a different color since you have to be extra careful. During a normal respray it does not matter so much if you miss a spot or if the paint end up a bit uneven. The base layer will not show up next to the final coat. However when you are changing color any imperfection will cause the base layer to shine through and be very visible. So a change in color was not free. The two shades also adds a bit to the complexity of the job increasing the cost of the respray.`,
         },
         {
            id: "vt0my9arth",
            text: `That is not a bad idea. I do see some stickers are already reapplied but those are the required ones. I was going to comment on it being on its side for it to be a flag, which does make it a bit easier to paint. But if they already had that in a proposed paint scheme then it is probably lucky for them.`,
         },
      ],
   },
   {
   ...
   },
   {
      ...
      comments: [
         {
            id: "v5vy5454ywv",
            text: "That blurb took him three months to write.",
         },
         {
            id: "vy54262v",
            text: "It was originally 5000 words detailing food at a banquet and all the crests and sigils present, with a side story with 20 new characters that he had trouble reconciling with the main plot.",
         },
         {
            id: "dhbth54q231",
            text: "hollowed out trenchers of bread, filled with... delicious stew!",
         },
         {
            id: "2g54626g54g54",
            text: "Below the salt. Above, capons.",
         },
         {
            id: "bu35e86m9",
            text: "And food dribbling down their chin!",
         },
      ],
   },
   {
      ...
      comments: [
         {
            id: "vterv54y742",
            text: "Comic Sans is ugly, but comic sans has a unique character for every character. You never have to worry if it's a 1, or an l, or an I, or a O or a 0, and that is something that is often not the case with other fonts.",
         },
         {
            id: "gh2j267jj27",
            text: `It's also one of the few fonts that has a lower-case A shaped how most people actually write a lower-case A.

        Handy for ESL teaching.`,
         },
         {
            id: "l48488l4wb2vs",
            text: "But not different enough from a cursive 2!",
         },
      ],
   },
   {
   ...
   },
   {
      ...
      comments: [
         {
            id: "oivfdsapjao8uvetrsip",
            text: "Interesting that this repudiation of reality, accountability & integrity that's happening in the USA driven by conservatives & Republicans is also happening in the UK with their conservative News Corp fawning leader Boris Johnson, as well as in Australia with their similarly described conservative leader Scott Morrison.",
         },
         {
            id: "vagoijt0v34",
            text: "Rupert Murdoch is the worst human being to have ever lived. The damage he has caused through his decades of propaganda and outright lies is impossible to calculate. I live in the UK, and it's almost impossible to avoid now.",
         },
         {
            id: "wbyn0wn7542",
            text: "The day he dies is when Satan finally has competition. Also, it will start a need to guard graveyards since his burial will likely become a global tourist portapotty",
         },
         {
            id: "m27m22m7274m",
            text: "Soon, I hope.",
         ...
         {
            id: "b265dcvb27",
            text: "He's already groomed his son as his successor, and he's not any better. Don't get too excited.",
         },
      ],
   },
   {
   ...
   },
   {
      ...
      comments: [
         {
            id: "b44527248",
            text: "Wow even Netflix…the Iron Curtain really is falling back into place. Except this time it's the West who's putting it in place. Hope Ukraine is worth it, Putin.",
         },
         {
            id: "n3863568563n",
            text: "Let's be fair, the fact that most Russians have no way to pay Netflix is likely the bigger issue.",
         },
         {
            id: "m8365m35635",
            text: "VISA cards still works within Russia",
         },
         {
            id: "3m856wtrwvb457",
            text: "Not for long. My Russian bank just sent me an email that visa/mc cards will stop working abroad in 3 days.",
         },
      ],
   },
   {
      ...
      comments: [
         ...
         {
            id: "nuen6858m38",
            text: "We give our lions red meat once a week. Please do not climb on the fences and ruin their diet.",
         },
         {
            id: "853b73653b7356m33",
            text: "This prompted me to lookup whether humans were considered red meat or not.",
         },
         {
            id: "h3568b35683m",
            text: "Well?",
   ...
   },
   {
      ...
      comments: [
         {
            id: "vwterewybwt74",
            text: "Aliens did this.",
         },
         {
            id: "wnytry45v42y42",
            text: "Well yea technically",
         },
         {
            id: "wntyw57643782",
            text: "We are what we have feared.",
         },
         {
            id: "n735675ty3",
            text: "and we having nothing to fear but fear itself, so ...",
         },
         {
            id: "3457b4btynw7",
            text: "And clowns, terrifying...",
         },
         {
            id: "wnty45cv43bum3578",
            text: "Space clowns, ooof",
         },
         {
            id: "63b5b58m89358",
            text: "I choose to misunderstand the scale and believe this hole is 1km wide exactly",
         },
      ],
   },
];
